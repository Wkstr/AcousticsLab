...
public:
    ...
    CmdCfgGEDAD()
        : Command("CFGGEDAD", "Configure the Gyroscope Euclidean Distance Anomaly Detection",
              core::ConfigObjectMap { CONFIG_OBJECT_DECL_FLOAT("anomaly_thresh", "Anomaly detection threshold",
                                          v0::shared::anomaly_threshold, 0.0f, 1.0f),
                  CONFIG_OBJECT_DECL_INTEGER("window_size", "Window size for anomaly detection",
                      v0::shared::window_size, 32, 768),
                  CONFIG_OBJECT_DECL_INTEGER("chunk_size", "Chunk size for anomaly detection", v0::shared::chunk_size,
                      32, 256),
                  CONFIG_OBJECT_DECL_INTEGER("num_chunks", "Number of chunks for anomaly detection",
                      v0::shared::num_chunks, 10, 100),
                  CONFIG_OBJECT_DECL_INTEGER("euclidean_avg_min_n_chunks",
                      "Euclidean distance average from minimal N chunks", v0::shared::euclidean_avg_min_n_chunks, 1,
                      20),
                  CONFIG_OBJECT_DECL_INTEGER("slide_step", "Slide step of chunks", v0::shared::slide_step, 1, 64),
                  CONFIG_OBJECT_DECL_INTEGER("chunk_extraction_after", "Chunk extraction after window size",
                      v0::shared::chunk_extraction_after, 0, 512),
                  CONFIG_OBJECT_DECL_INTEGER("event_report_interval", "Event report interval in milliseconds",
                      v0::shared::event_report_interval, -1, std::numeric_limits<int>::max()),
                  CONFIG_OBJECT_DECL_FLOAT("gravity_correction_alpha", "Gravity correction factor alpha",
                      v0::shared::gravity_correction_alpha.load(), 1.0f, 100.0f),
                  CONFIG_OBJECT_DECL_FLOAT("gravity_correction_beta", "Gravity correction factor beta",
                      v0::shared::gravity_correction_beta.load(), -std::numeric_limits<float>::infinity(),
                      std::numeric_limits<float>::infinity()),
                  CONFIG_OBJECT_DECL_INTEGER("abnormal_output_gpio", "GPIO pin for abnormal output (0 to disable)",
                      v0::shared::abnormal_output_gpio, -1, 64),
                  CONFIG_OBJECT_DECL_INTEGER("abnormal_output_gpio_value",
                      "GPIO value for abnormal output (1 for high, 0 for low)", v0::shared::abnormal_output_gpio_value,
                      0, 1) }),
