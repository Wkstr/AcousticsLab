#pragma once
#ifndef BOARD_RESPEAKER_LITE_HPP
#define BOARD_RESPEAKER_LITE_HPP
...
namespace board { namespace respeaker_lite {
    ...
    // I2S Role
    constexpr i2s_role_t I2S_ROLE = I2S_ROLE_SLAVE;

    // I2S Standard Mode Pins
    constexpr gpio_num_t I2S_BCLK_PIN = GPIO_NUM_8;
    constexpr gpio_num_t I2S_WS_PIN = GPIO_NUM_7;
    constexpr gpio_num_t I2S_DIN_PIN = GPIO_NUM_44;
    constexpr gpio_num_t I2S_DOUT_PIN = GPIO_NUM_43;
...
}} // namespace board::respeaker_lite

#endif // BOARD_RESPEAKER_LITE_HPP
